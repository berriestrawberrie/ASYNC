...
var fetchAdviceBy = function (id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("https://api.adviceslip.com/advice/".concat(id))];
            case 1:
                response = _a.sent();
...
(_a = document.getElementById("play")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", getAdviceAfterGame);
